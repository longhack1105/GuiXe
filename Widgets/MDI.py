...
class MDIChild(Canvas):
    def __init__(self, parent, title='', iconfile=path+'tk.gif', topcolor=None,
        ...
        self.image = Image.open(iconfile)
    ...
    def resize(self, event):
        ...
        if xmouse < 100 or xmouse > w or ymouse < 100 or ymouse > h: 
            return
...
def putTree(document):
    ...
    lbl = Label(document.interior, text='dddddddddddddd')
    lbl.pack()
    
    document.widgetSetFocus(lbl)  ## important for setting focus to MDIChild ##
